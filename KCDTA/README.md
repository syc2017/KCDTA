...
For the results of reproducing the **PDBBind Refined** dataset, no code modification is required, just copy the model parameters from the cloud disk(https://drive.google.com/file/d/1nsL6QR0xlY_JRVyUuLI47dRAFjRvvOyF/view?usp=drive_link) to the KCDTA directory after creating the dataset, and execute
``` python
python test.py 2
```
